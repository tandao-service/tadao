...
const LocationSelection = ({ onClose, onSelected, handleFilter, AdsCountPerRegion }: Props) => {
  ...
  return (<>
     {isMobile ? (
          ...
          <div className="absolute h-[80vh] bg-gray-200 dark:bg-[#2D3236] dark:text-gray-100 rounded-lg w-full max-w-full p-5">
            ...
            <div className="mt-1 max-h-[65vh] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
          ...
          {selectedLocation && (
            <div className="absolute h-[80vh] bg-gray-200 dark:bg-[#2D3236] dark:text-gray-100 rounded-lg w-full max-w-full p-5">
              ...
              <div className="mt-1 max-h-[60vh] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                <ul className="cursor-pointer p-0">
