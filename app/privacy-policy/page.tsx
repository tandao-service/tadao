...
export const metadata: Metadata = {
    title: "Privacy Policy | Tadao Market",
    description:
        "Read the privacy policy for using tadaomarket.com, our online marketplace.",
    keywords: [
        "tadaomarket",
        "privacy policy",
        "Kenya e-commerce",
    ...
    alternates: {
        canonical: "https://www.tadaomarket.com/privacy",
    },
    openGraph: {
        title: "Privacy Policy | tadaomarket.com",
        description:
            "Understand the privacy policy for using tadaomarket.com, your trusted marketplace in Kenya.",
        type: "website",
        url: "https://www.tadaomarket.com/privacy",
        images: ["https://www.tadaomarket.com/assets/images/terms-and-conditions-cover.jpg"],
    },
    twitter: {
            ...
            <div>
                ...
                <div className="border rounded-lg dark:bg-[#2D3236] bg-white max-w-6xl mx-auto lg:flex-row mt-0 p-1 justify-center">
                    <div className="privacy-policy p-6 dark:text-gray-300 text-gray-800">
                        ...
                        <p className="mb-4">
                            Your privacy is important to us at <strong>Tadao Market</strong>.
                            This Privacy Policy explains how we collect, use, disclose, and
                            safeguard your information when you visit our website or use our
                            services. By using our site, you agree to the terms outlined in
                            this policy. If you do not agree with the terms, please do not use
                            our website.
                        </p>
                        ...
                        <p className="mb-4">
                            ...
                            when you create an account, post a listing, or contact us,
                            including:
                        </p>
                        ...
                        <p className="mb-4">
                            ...
                            how you access and use our website, including:
                        </p>
                        ...
                        <ul className="list-disc list-inside ml-6 mb-4">
                            <li>
                                Your account information and data will be permanently deleted and
                                cannot be recovered.
                            </li>
                            <li>
                                You will no longer have access to any data or content associated
                                with your account.
                            </li>
                            <li>
                            ...
                            <li>
                                To delete your account: Go to &apos;Your Profile&apos;, then click
                                the settings icon on the right side to open the settings page.
