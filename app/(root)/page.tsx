...
import {
  getAllCategoriesCached, getAllSubCategoriesCached, getAllPackagesCached,
  getAdsCountAllRegionCached, getallPendingLaonsCached,
} from "@/lib/actions/cached.actions";
import { GlobalDataProvider } from "@/public/context/GlobalDataContext";
import { SearchParamProps } from "@/types";

export const metadata = {
  // optional: homepage-specific canonical (it merges with layout)
