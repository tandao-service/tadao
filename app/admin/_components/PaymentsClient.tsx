...
import CollectionPayments from "@/components/shared/CollectionPayments";
import {
    AdminCard,
    AdminPageHeader,
    AdminSectionLoader,
...
export default function PaymentsClient() {
    ...
    useEffect(() => {
        ...
        async function load() {
            try {
                setLoading(true);
                const res = await getallPayments(transactionId, start, end, limit, page);
                if (!cancelled) setPayments(res);
            } catch (error) {
    ...
    if (loading) {
        return <AdminSectionLoader label="Loading payments..." />;
    }
    ...
    return (
        <>
            <AdminPageHeader
                eyebrow="Payments"
                title="Payments"
                subtitle="Track recorded payments and reconciliation."
            />
