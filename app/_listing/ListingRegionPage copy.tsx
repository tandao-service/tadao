...
import { getCategoryTreeForHome, getTotalAdsForRegion } from "@/lib/home/home.categories";
...
export default async function ListingPageUI(args: {
    ...
    const homeTree = await getCategoryTreeForHome(80, 200, args.regionSlug).catch(() => []);
