...
export default function ListingPageClient(props: Props) {
    ...
    const onCategoryListingPick = React.useCallback(
        async (selectedSlug: string) => {
            ...
            const nextCategoryName = String(selectedCategory.name).trim();
            const nextIsVehicle =
                nextCategoryName.toLowerCase() === "vehicle";

            setCategoryName(nextCategoryName);
            setIsVehicle(nextIsVehicle);
            setCategoryListings(selectedCategory.listings || []);
            setCountsBySubFallback(selectedCategory.countsBySub || {});
            setTotalFallback(Number(selectedCategory.count || 0));
    ...
    const FiltersContent = (
        <div className="space-y-5">
            ...
            <div>
                ...
                {/* Mobile: custom picker instead of Android/browser native select */}
                <button
                    type="button"
                    onClick={() => {
                    ...
                    className="flex min-h-[58px] w-full items-center gap-3 rounded-2xl border border-slate-200 bg-white px-3.5 text-left shadow-sm transition active:scale-[0.99] md:hidden"
                >
                    <span className="grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-orange-50 text-orange-600 ring-1 ring-orange-100">
                ...
                <div className="relative hidden md:block">
                    ...
                    <select
                        value={activeSlug}
                        onChange={async (e) => {
                            await onCategoryListingPick(e.target.value);
                        }}
                        className="
                            h-14
                            w-full
        ...
        "
            ...
            {catsOpen ? (
                <div className="fixed inset-0 z-[900] md:hidden">
                    ...
                    <div
                        className="absolute inset-x-0 bottom-0 max-h-[88dvh] overflow-hidden rounded-t-[28px] bg-[#FBFAF6] shadow-[0_-18px_60px_rgba(15,23,42,0.18)]"
                    ...
                    >
                        ...
                        <div className="sticky top-0 z-10 border-b border-slate-200 bg-[#FBFAF6]/95 px-4 pb-3 pt-2 backdrop-blur-xl">
                            <div className="flex items-center justify-between gap-3">
                                <div className="min-w-0">
                                    <div className="text-[11px] font-extrabold uppercase tracking-[0.08em] text-orange-600">
                                        Browse
                                    </div>
                                    <div className="mt-0.5 text-[17px] font-black tracking-[-0.02em] text-slate-950">
                                        Choose category
                                    </div>
                                </div>
                                ...
                                <button
                                    type="button"
                                    onClick={() => setCatsOpen(false)}
                                    className="grid h-10 w-10 shrink-0 place-items-center rounded-full border border-slate-200 bg-white text-slate-600 shadow-sm active:scale-95"
                                    aria-label="Close categories"
                                >
                                    <X className="h-4 w-4" />
                                </button>
                            ...
                            <div className="mt-3 flex items-center gap-2 rounded-2xl border border-orange-100 bg-orange-50 px-3 py-2.5">
                                <span className="grid h-8 w-8 shrink-0 place-items-center rounded-xl bg-white text-orange-600 shadow-sm">
                        ...
                        <div className="max-h-[calc(88dvh-150px)] overflow-y-auto px-3 py-3">
                                ...
                                {props.categories.map((c, index) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={[
                                                "flex min-h-[64px] w-full items-center gap-3 rounded-2xl border px-3 py-2.5 text-left transition active:scale-[0.99]",
                                                activeCat
                                                    ? "border-orange-200 bg-orange-50 shadow-[0_7px_20px_rgba(249,115,22,0.08)]"
                                                    : "border-slate-200 bg-white shadow-[0_4px_14px_rgba(15,23,42,0.035)]",
                                            ].join(" ")}
                                        >
                                            ...
                                            <div className="min-w-0 flex-1">
                                                ...
                                                <div className="mt-0.5 text-[11px] font-semibold text-slate-500">
                                                    {Number(c.count || 0).toLocaleString()} listings
                                                </div>
                                            </div>
            ...
            {subsOpen ? (
                <div className="fixed inset-0 z-[910] md:hidden">
                    ...
                    >
                        ...
                        <div className="sticky top-0 z-10 border-b border-slate-200 bg-[#FBFAF6]/95 px-4 pb-3 pt-2 backdrop-blur-xl">
                            <div className="flex items-center justify-between gap-3">
                                <button
                                    ...
                                    className="inline-flex h-10 items-center gap-1.5 rounded-full border border-slate-200 bg-white px-3 text-[12px] font-extrabold text-slate-700 shadow-sm active:scale-95"
                                >
                                    <ArrowLeft className="h-4 w-4" />
                                    Back
                                </button>
                        ...
                        <div className="max-h-[calc(88dvh-92px)] overflow-y-auto px-3 py-3">
                            <div className="space-y-2">
                                {props.categories
                                    .find(
                                        (c) =>
                                    ...
                                    ?.listings?.map((it, index) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                onClick={async () => {
                                                    setSubsOpen(false);
                                                    await onCategoryListingPick(it.slug);
                                                }}
                                                className={[
                                                    "flex min-h-[64px] w-full items-center gap-3 rounded-2xl border px-3 py-2.5 text-left transition active:scale-[0.99]",
                                                    isActiveSlug
